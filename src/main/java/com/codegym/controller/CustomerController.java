...
public class CustomerController {
    ...
    @GetMapping
    public ModelAndView listCustomer(@RequestParam("page") Optional<Integer> page,
    ...
    @GetMapping("/search")
    public ModelAndView listCustomersSearch(@RequestParam("search") Optional<String> search,
